<template >
  <div class="page">
    <div class="content">
      <h1 square='' flat='' style='position:absolute;top:-5rem;width:100%;'></h1>
        <div style='text-align:center;'>
          <span style='font-weight:bold;font-size:1.5rem;color:white;text-shadow:blue 0 1px 0;'> 上海大学计算机学院</span>
          <br>
        </div>
      </div>
      <form>
        ...
        <button class="full-width" :plain="true" :size="mini" loader='' color='primary' @click='login' :loading='loginLoading'>确认绑定</button>
      </form>
      <div square='' flat='' style='position:absolute;bottom:-4rem;width:100%;'>
        <div style='text-align:center;color:white;font-size:0.8rem;'>
          <small> 2018 SHU Open Source Community</small>
        </div>
      </div>
